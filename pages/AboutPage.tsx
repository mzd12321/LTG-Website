      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-gray-300 mb-11 text-lg">
            ...
            <p className="text-gray-300 text-lg mb-4">
              Our founder, Xander, grew up in Thailand, where stark income inequality was part of daily life. Having lived in both developed Bangkok and rural Isan, he saw the vast disparities—many children attending school without proper uniforms, stationery, or shoes. In Thailand, school shoes cost under £5, and basic stationery even less.
            </p>
            <p className="text-gray-300 text-lg">
              This is where purchasing power parity matters: what may seem like a small contribution in the UK can equip a child in rural Thailand with the essentials to stay in school, keep learning, and pursue a brighter future.
            </p>
          </div>
          <div className="rounded-lg overflow-hidden shadow-2xl flex justify-center">
            <img
              src="/assets/donations2.png"
              alt="Donations making an impact for students in Thailand"
        ...
        <div className="text-center mt-20">
          ...
          <a
            href="https://www.justgiving.com/crowdfunding/learn-to-give?fbclid=PAZXh0bgNhZW0CMTEAAadYrTVJNa8j_qks6r8sqYB1dZ8q_S4sJsLinkvjXmJeUMMCv5_B4hx1varvTQ_aem_gZ8wkk3SR6RI9faix_jHgQ" // Placeholder for Google Sheet/PDF link
            target="_blank"
