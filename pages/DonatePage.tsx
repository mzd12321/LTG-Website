        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-10">
              ...
              <a
                href="https://www.justgiving.com/crowdfunding/learn-to-give?fbclid=PAZXh0bgNhZW0CMTEAAadYrTVJNa8j_qks6r8sqYB1dZ8q_S4sJsLinkvjXmJeUMMCv5_B4hx1varvTQ_aem_gZ8wkk3SR6RI9faix_jHgQ"
                target="_blank"
            ...
            <div className="mt-12 pt-8 border-t border-gray-700">
              ...
              <a
                href="https://www.justgiving.com/crowdfunding/learn-to-give?fbclid=PAZXh0bgNhZW0CMTEAAadYrTVJNa8j_qks6r8sqYB1dZ8q_S4sJsLinkvjXmJeUMMCv5_B4hx1varvTQ_aem_gZ8wkk3SR6RI9faix_jHgQ" // Placeholder for transparency report
                target="_blank"
                rel="noopener noreferrer"
